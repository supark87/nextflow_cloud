...
process annotate {
    ...
    script:
        """
        java -Xmx8g -jar /tmp/snpEff/snpEff.jar build -c ${configpath}/snpEff.config -v -gff3 6genes2
        #java -Xmx8g -jar /tmp/snpEff/snpEff.jar build -c ${configpath}/snpEff.config -v -gff3 6genes2
        #java -Xmx8g -jar /tmp/snpEff/snpEff.jar build -c ${configpath}/snpEff.config -v -gff3 6genes2

        java -Xmx8g -jar /tmp/snpEff/snpEff.jar -c ${configpath}/snpEff.config 6genes2 ${vcf_path1} > ${sample}-1.ann.vcf
        java -Xmx8g -jar /tmp/snpEff/snpEff.jar -c ${configpath}/snpEff.config 6genes2 ${vcf_path1} > ${sample}-2.ann.vcf
        java -Xmx8g -jar /tmp/snpEff/snpEff.jar -c ${configpath}/snpEff.config 6genes2  ${vcf_path1} > ${sample}-3.ann.vcf

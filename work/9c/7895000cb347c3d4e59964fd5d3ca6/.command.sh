#!/bin/bash -ue
java -jar /usr/picard/picard.jar AddOrReplaceReadGroups -I 19ANBe28D0009PfFxxx0_S33_L001.sam -O 19ANBe28D0009PfFxxx0_S33_L001_SR.bam -SORT_ORDER coordinate --CREATE_INDEX true \

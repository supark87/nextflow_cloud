#!/bin/bash -ue
java -jar picard.jar AddOrReplaceReadGroups -I 19ANBe21D0042PfFxxx0_S40_L001.sam -O 19ANBe21D0042PfFxxx0_S40_L001_SR.bam -SORT_ORDER coordinate --CREATE_INDEX true \

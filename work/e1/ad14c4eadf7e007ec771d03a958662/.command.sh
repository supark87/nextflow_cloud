#!/bin/bash -ue
/Users/subinpark/Downloads/from_jehoon/bbduk.sh -Xmx1g k=27 hdist=1 edist=1 ktrim=l in=19ANBe00D0066PfFxxx0_S10_L001_R1.fastq.gz in2=19ANBe00D0066PfFxxx0_S10_L001_R2.fastq.gz \

#!/bin/bash -ue
java -jar /usr/picard/picard.jar AddOrReplaceReadGroups -I 19ANBe00D0042PfFxxx0_S8_L001.sam -O 19ANBe00D0042PfFxxx0_S8_L001_SR.bam -SORT_ORDER coordinate --CREATE_INDEX true \
